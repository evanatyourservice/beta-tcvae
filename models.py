...
class VAE(nn.Module):
    def __init__(self, z_dim, use_cuda=True, prior_dist=dist.Normal(), q_dist=dist.Normal(),
    ...
    def elbo(self, x, dataset_size):
        ...
        # Return all relevant terms for logging
        return (modified_elbo, elbo), (logpx, logpz, logqz_condx)
